...
\Rep[abcat][e]{$1 \land 2 \yluego 3 \yluego 4 \yluego 5 \yluego 6 \land 7 \land 8 \land 9$}\mbox{}
...
\item No existen dos categor\'ias iguales en un mismo \'arbol.\\
  ...
  \item Cada categor\'ia tiene un \'unico padre (este \'item (junto con el 4) garantiza que el \'arbol no sea c\'iclico).\\
