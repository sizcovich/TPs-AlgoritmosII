...
\begin{Interfaz}
	...
	\textbf{g\'eneros}: \TipoVariable{diccTrie}.
	...
	\InterfazFuncion{Significado}{\Inout{d}{diccTrie}, \In{k}{string}}{$\alpha$}
	  [$def?(d, k)$]
...
\Procedure{iAgregar}{\Inout{ac}{abCat}, \In{padre}{categoria}, \In{hija}{categoria}}
	...
	\\
	\State $infoPadre \gets$ Significado($ac.categorias$, $padre$)\Comment{O(|$padre$|)}
...
\end{Representacion}
%LinkLinkIt se representa con
%tupla<abcat, vector(conj(link)), DiccTrie(link,tupla<categoria,
% secu(accesos)>)>
