...
\begin{Operacion Auxiliar}
	...
	\InterfazFuncion{crearNodo}{\In {c}{char}}{nodo}
	  ...
	  [O(1)]
	  [Genera un nodo con todos los punteros a NULL y con el char que se pasa como par\'ametro almacenado en el campo letra.]
...
\begin{algorithmic}[1]
	...
	\EndIf	\Comment{O(1)}
	\Statex	
	\Statex // Se toma el primer nodo. si cargoTodo? es true, entonces en el bucle se crear\'an todos los nodos hasta formar // k. Si cargoTodo? es false entonces se ir\'a recorriendo todo el \'arbol hasta encontrar el lugar donde habr\'a // que colocar el resto de los caracteres de k que no est\'en en el \'arbol.	
	\Statex
