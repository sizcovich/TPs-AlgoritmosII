...
\tadOperacion{visitasDeHoy}{link,sist \ s, sist \ s'}{secu(fecha)}{s = s'}
\tadOperacion{visitasDeAyer}{link,sist \ s, sist \ s'}{secu(fecha)}{s = s'}
\tadOperacion{visitasDeAntesdeayer}{link,sist \ s, sist \ s'}{secu(fecha)}{s = s'}
...
\tadAxioma{visitasDeHoy(l, inicio(a), s')}{$<>$}
\tadAxioma{visitasDeHoy(l, registrarAcceso(f, l', s), s')}{\IF (l = l' $\land$ ultimoAcceso(s') = f) THEN f $\bullet$ visitasDeHoy(l , s, s') ELSE visitasDeHoy(l, s, s') FI}
\tadAxioma{visitasDeHoy(l, registrarLink(l', n, s), s')}{visitasDeHoy(l, s, s')}
\tadAxioma{visitasDeAyer(l, inicio(a), s')}{$<>$}
\tadAxioma{visitasDeAyer(l, registrarAcceso(f, l', s), s')}{\IF (l = l' $\land$ (ultimoAcceso(s')- 1) = f) THEN f $\bullet$ visitasDeAyer(l , s, s') ELSE visitasDeAyer(l, s, s') FI}
\tadAxioma{visitasDeAyer(l, registrarLink(l', n, s), s')}{visitasDeAyer(l, s, s')}
\tadAxioma{visitasDeAntesdeayer(l, inicio(a), s')}{$<>$}
\tadAxioma{visitasDeAntesdeayer(l, registrarAcceso(f, l', s), s')}{\IF (l = l' $\land$ (ultimoAcceso(s')- 2) = f) THEN f $\bullet$ visitasDeAntesdeayer(l , s, s') ELSE visitasDeAntesdeayer(l, s, s') FI}
