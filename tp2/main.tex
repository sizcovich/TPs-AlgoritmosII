...
\begin{enumerate}
  ...
  \item Cada categor\'ia tiene un \'unico padre (este \'item (junto con el 2,3 y 4) garantiza que el \'arbol no sea c\'iclico) (esto supuestamente queda expl\'icito pues el padre es un puntero).\\
