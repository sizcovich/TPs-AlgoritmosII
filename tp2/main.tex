...
\begin{algorithm}[H]
\caption*{iDefinir(\In{ac}{abCat}) $\DRef res$ : \TipoVariable{categoria}}
\begin{algorithmic}[1]
	\State $COMPLETAR$ \Comment{O(1)}	
\end{algorithmic}
\textbf{C\'alculo de complejidad}: 
\end{algorithm}

\begin{algorithm}[H]
\caption*{iDefinido?(\Inout{ac}{abCat}, \In{padre}{categoria}, \In{hija}{categoria})}
\begin{algorithmic}[1]
	\State $COMPLETAR$ \Comment{O(1)}	
\end{algorithmic}
\textbf{C\'alculo de complejidad}: 
...
\begin{algorithm}[H]
\caption*{iObtener(\In{ac}{abCat}, \In{padre}{categoria}) $\DRef res$ : \TipoVariable{iteradorUni(categoria)}}
\begin{algorithmic}[1]
	\State $COMPLETAR$ \Comment{O(1)} 
\end{algorithmic}
\textbf{C\'alculo de complejidad}:   
