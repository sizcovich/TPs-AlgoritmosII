...
\tadOperacion{AccesosRecientes}{link, sist \ s, sist \ s'}{nat}{linkEnSist $\land$ s = s'}
\tadAxiomas
...
\tadAxioma{AccesosRecientes(l, inicio(a), s')}{0}
\tadAxioma{AccesosRecientes(l, registrarAcceso(f, l', s), s')}{if ((l $=$ l') $\land$ (ultimoAcceso (s') - 3) $\leq$ f) then 1 + accesosRecientes (l, s, s') else accesosRecientes (l, s, s') fi}
\tadAxioma{AccesosRecientes(l, registrarLink(l', n, s), s')}{AccesosRecientes (l, s, s')}
