...
\tadAlinearAxiomas{todasLasCategorias(nodo(n, ca))}{Ag(n, sacarNombres (ca))}
...
\tadObservadores
\tadAlinearFunciones{registrarAcceso}{link l,nombre n,sist s}{sist}{linkUnico(l, s) $\land$ nombreEnSist(n, s)}
...
\tadAlinearAxiomas{nombreEnSist(n, registrarAcceso(f, l, s))}{nombreEnSist(n, s)}
